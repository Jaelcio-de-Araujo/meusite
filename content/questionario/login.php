...
<div class="container">
	<div class="row login_box">
	    <div class="col-md-12 col-xs-12" align="center">
            ...
            <div class="outter"><img src="img/thais.jpg" class="image-circle"/></div>   
            <h1>Olá, Thais!</h1>
            <span>Osasco</span>
	    </div>
        <div class="col-md-6 col-xs-6 follow line" align="center">
            <h3>
                 100000 <br/> <span>Visualizações</span>
            </h3>
        </div>
        <div class="col-md-6 col-xs-6 follow line" align="center">
            <h3>
        ...
        <div class="col-md-12 col-xs-12 login_control">
                ...
                <div class="control">
				 <form name="login" method="post" autocomplete="off" action="autenticar.php">	
				...
				<div class="control">
                     <div class="label">Professor</div>
						<select class="form-control" name="professor">
							  <option value="Beatriz" class="form-control">Beatriz</option>
							  <option value="Marcus" class="form-control">Marcus</option>
							  <option value="Lucas" class="form-control">Lucas</option>
							  <option value="Jaelcio" class="form-control">Jaelcio</option>
							  <option value="Jadih" class="form-control">Jadih</option>
							  <option value="Demmis" class="form-control">Demmis</option>
